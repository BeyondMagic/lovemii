...
insert.status.left({
  ...
  diff_color = {
    ...
    added    = { fg = colours.add },  -- Changes the diff's added color
    modified = { fg = colours.change },  -- Changes the diff's modified color
    removed  = { fg = colours.red }  -- Changes the diff's removed color you
  },
...
insert.status.right({
  ...
  diagnostics_color = {
    ...
    error = { fg = colours.error }, -- Changes diagnostics' error color.
    warn  = { fg = colours.warning }, -- Changes diagnostics' warn color.
    info  = { fg = colours.information }, -- Changes diagnostics' info color.
    hint  = { fg = colours.hint }  -- Changes diagnostics' hint color.,
  },
