...
return require('packer').startup( function(use)
  ...
  use {
    ...
    "Pocco81/true-zen.nvim",
    config = require('configuration.true-zen')
  }
  ...
  use {
    ...
    requires = {
      ...
      --"/home/spirit/Git/Contributing/nvim-navic",
      "SmiteshP/nvim-navic",
  ...
  --   config = require('configuration.cinnamon'),
  -- }
  ...
  use {
    ...
    requires = 'nvim-lua/plenary.nvim',
    --config   = require('configuration.diffview'),
  }
  ...
  use '~/Programming/Projects/arcoiris-nvim-theme'
