...
declare const AgsEntry_base: {
    new (...args: any[]): {
        ...
        connections: ([import("@girs/gobject-2.0").GObject.Object, (self: Gtk.Entry, ...args: unknown[]) => unknown, (string | undefined)?] | [string, (self: Gtk.Entry, ...args: unknown[]) => unknown] | [number, (self: Gtk.Entry, ...args: unknown[]) => unknown])[];
