...
declare const AgsRevealer_base: {
    new (...args: any[]): {
        ...
        connections: ([import("@girs/gobject-2.0").GObject.Object, (self: Gtk.Revealer, ...args: unknown[]) => unknown, (string | undefined)?] | [string, (self: Gtk.Revealer, ...args: unknown[]) => unknown] | [number, (self: Gtk.Revealer, ...args: unknown[]) => unknown])[];
