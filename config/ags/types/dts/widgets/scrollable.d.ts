...
declare const AgsScrollable_base: {
    new (...args: any[]): {
        ...
        connections: ([import("@girs/gobject-2.0").GObject.Object, (self: Gtk.ScrolledWindow, ...args: unknown[]) => unknown, (string | undefined)?] | [string, (self: Gtk.ScrolledWindow, ...args: unknown[]) => unknown] | [number, (self: Gtk.ScrolledWindow, ...args: unknown[]) => unknown])[];
