...
declare const AgsSlider_base: {
    new (...args: any[]): {
        ...
        connections: ([import("@girs/gobject-2.0").GObject.Object, (self: Gtk.Scale, ...args: unknown[]) => unknown, (string | undefined)?] | [string, (self: Gtk.Scale, ...args: unknown[]) => unknown] | [number, (self: Gtk.Scale, ...args: unknown[]) => unknown])[];
