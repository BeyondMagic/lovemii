...
declare const AgsCircularProgress_base: {
    new (...args: any[]): {
        ...
        connections: ([import("@girs/gobject-2.0").GObject.Object, (self: Gtk.Bin, ...args: unknown[]) => unknown, (string | undefined)?] | [string, (self: Gtk.Bin, ...args: unknown[]) => unknown] | [number, (self: Gtk.Bin, ...args: unknown[]) => unknown])[];
