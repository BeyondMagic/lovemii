...
declare const AgsIcon_base: {
    new (...args: any[]): {
        ...
        connections: ([import("@girs/gobject-2.0").GObject.Object, (self: Gtk.Image, ...args: unknown[]) => unknown, (string | undefined)?] | [string, (self: Gtk.Image, ...args: unknown[]) => unknown] | [number, (self: Gtk.Image, ...args: unknown[]) => unknown])[];
