...
declare const AgsBox_base: {
    new (...args: any[]): {
        ...
        connections: ([import("@girs/gobject-2.0").GObject.Object, (self: Gtk.Box, ...args: unknown[]) => unknown, (string | undefined)?] | [string, (self: Gtk.Box, ...args: unknown[]) => unknown] | [number, (self: Gtk.Box, ...args: unknown[]) => unknown])[];
