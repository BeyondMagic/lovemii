...
declare const AgsButton_base: {
    new (...args: any[]): {
        ...
        connections: ([import("@girs/gobject-2.0").GObject.Object, (self: Gtk.Button, ...args: unknown[]) => unknown, (string | undefined)?] | [string, (self: Gtk.Button, ...args: unknown[]) => unknown] | [number, (self: Gtk.Button, ...args: unknown[]) => unknown])[];
