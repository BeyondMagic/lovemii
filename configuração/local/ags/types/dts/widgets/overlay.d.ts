...
declare const AgsOverlay_base: {
    new (...args: any[]): {
        ...
        connections: ([import("@girs/gobject-2.0").GObject.Object, (self: Gtk.Overlay, ...args: unknown[]) => unknown, (string | undefined)?] | [string, (self: Gtk.Overlay, ...args: unknown[]) => unknown] | [number, (self: Gtk.Overlay, ...args: unknown[]) => unknown])[];
