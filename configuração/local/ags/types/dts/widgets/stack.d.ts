...
declare const AgsStack_base: {
    new (...args: any[]): {
        ...
        connections: ([import("@girs/gobject-2.0").GObject.Object, (self: Gtk.Stack, ...args: unknown[]) => unknown, (string | undefined)?] | [string, (self: Gtk.Stack, ...args: unknown[]) => unknown] | [number, (self: Gtk.Stack, ...args: unknown[]) => unknown])[];
