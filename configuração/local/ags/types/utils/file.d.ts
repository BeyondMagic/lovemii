...
export declare function monitorFile(path: string, callback?: (file: Gio.File, event: Gio.FileMonitorEvent) => void, flags?: Gio.FileMonitorFlags): Gio.FileMonitor | null;
