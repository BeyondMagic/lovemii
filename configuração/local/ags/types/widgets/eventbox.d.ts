...
declare const AgsEventBox_base: {
    new (...args: any[]): {
        ...
        connections: ([import("@girs/gobject-2.0").GObject.Object, (self: Gtk.EventBox, ...args: unknown[]) => unknown, (string | undefined)?] | [string, (self: Gtk.EventBox, ...args: unknown[]) => unknown] | [number, (self: Gtk.EventBox, ...args: unknown[]) => unknown])[];
