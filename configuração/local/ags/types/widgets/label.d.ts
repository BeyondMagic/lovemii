...
declare const AgsLabel_base: {
    new (...args: any[]): {
        ...
        connections: ([import("@girs/gobject-2.0").GObject.Object, (self: Gtk.Label, ...args: unknown[]) => unknown, (string | undefined)?] | [string, (self: Gtk.Label, ...args: unknown[]) => unknown] | [number, (self: Gtk.Label, ...args: unknown[]) => unknown])[];
        ...
        custom_tag_start(builder: Gtk.Builder, child: import("@girs/gobject-2.0").GObject.Object | null, tagname: string): [boolean, GLib.MarkupParser, any];
        ...
        vfunc_custom_tag_start(builder: Gtk.Builder, child: import("@girs/gobject-2.0").GObject.Object | null, tagname: string): [boolean, GLib.MarkupParser, any];
