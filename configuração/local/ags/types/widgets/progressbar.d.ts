...
declare const AgsProgressBar_base: {
    new (...args: any[]): {
        ...
        connections: ([import("@girs/gobject-2.0").GObject.Object, (self: Gtk.ProgressBar, ...args: unknown[]) => unknown, (string | undefined)?] | [string, (self: Gtk.ProgressBar, ...args: unknown[]) => unknown] | [number, (self: Gtk.ProgressBar, ...args: unknown[]) => unknown])[];
