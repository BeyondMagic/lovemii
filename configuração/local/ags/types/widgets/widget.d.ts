...
declare function AgsWidget<W extends WidgetCtor, Self extends InstanceType<W>>(Widget: W, typename?: string): {
    new (...args: any[]): {
        ...
        get_template_child(widget_type: GObject.GType<unknown>, name: string): GObject.Object;
        ...
        bind_property_full(source_property: string, target: GObject.Object, target_property: string, flags: GObject.BindingFlags, transform_to: GObject.TClosure<any, any>, transform_from: GObject.TClosure<any, any>): GObject.Binding;
        force_floating(): void;
        freeze_notify(): void;
        ...
        custom_finished(builder: Gtk.Builder, child: GObject.Object | null, tagname: string, data: any): void;
        custom_tag_end(builder: Gtk.Builder, child: GObject.Object | null, tagname: string, data: any): void;
        ...
        vfunc_custom_finished(builder: Gtk.Builder, child: GObject.Object | null, tagname: string, data: any): void;
        vfunc_custom_tag_end(builder: Gtk.Builder, child: GObject.Object | null, tagname: string, data: any): void;
