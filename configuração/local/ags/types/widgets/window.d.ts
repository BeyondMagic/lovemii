...
declare const AgsWindow_base: {
    new (...args: any[]): {
        ...
        connections: ([import("@girs/gobject-2.0").GObject.Object, (self: Gtk.Window, ...args: unknown[]) => unknown, (string | undefined)?] | [string, (self: Gtk.Window, ...args: unknown[]) => unknown] | [number, (self: Gtk.Window, ...args: unknown[]) => unknown])[];
